...
return [
    ...
    */
    ...
    'array' => 'T:attributeには、配列を指定してください。',
    ...
    'current_password' => 'このパスワードは正しくありません。',
    ...
    'distinct' => 'T:attributeの値が重複しています。',
    ...
    'gt' => [
        ...
        'file' => 'T:attributeは、:value KBより大きくなければなりません。',
    ...
    'max' => [
        'numeric' => 'T:attributeには、:max以下の数字を指定してください。',
